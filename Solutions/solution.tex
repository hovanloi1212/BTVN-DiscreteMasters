...
\clearpage
\subsubsection{Bài tập 5}
\textbf{Đề bài:} Show that [p ^ (p ! q)] ! q is a tautology using truth tables
\\\ \\\
\textbf{Lời giải:} \\\ \\\
\clearpage
\subsubsection{Bài tập 6}
\textbf{Đề bài:} Prove1 that $(p \implies q) \lor (p \implies r)$ và $p \implies (q \lor r)$ are logically equivalent (without using
...
\clearpage
\subsubsection{Bài tập 3}
\textbf{Đề bài:} Let P(x; y), Q(x; y), and R(x) be propositional functions. Use logical equivalences to
show that $\exists x (\lnot R(x) \land \forall y (\lnot Q(x,y) \land P(x,y)))$ are equivalent
\\\ \\\
\textbf{Lời giải:} \\\ \\\
...
\clearpage
\subsubsection{Bài tập 5}
\textbf{Đề bài:} Let A and B be sets. Prove that 
\textbf{Lời giải:} \\\ \\\
\clearpage
\subsubsection{Bài tập 6}
\textbf{Đề bài:} Let A, B, and C be subsets of a universe U. Use definitions of set operations and set
...
\clearpage
\subsubsection{Bài tập 3}
\textbf{Đề bài:} Mathematical induction can be used to prove things that can be proven directly. In
