...
b) Ta có: \\\
$\lnot(p \land (q\lor r)) \land (\lnot p \lor \lnot q \lor r) \\\equiv (\lnot p \lor \lnot (q\lor r)) \land (\lnot p \lor \lnot q \lor r) \\\equiv \lnot p \lor ( \lnot (q\lor r)) \land (\lnot q \lor r)) \\\equiv \lnot p \lor \lnot ((q\lor r) \lor (q \land \lnot r)) \\\equiv\lnot p \lor \lnot (q\lor ((r \lor q) \land (r \lor \lnot r)) \\\equiv \lnot p \lor \lnot (q\lor r)$ \\\ \\\
c) Ta có: \\\
...
\textbf{Lời giải:} \\\ \\\
Ta có thể biểu diễn sang: $a \leftrightarrow e$.
\clearpage
...
\textbf{Lời giải:} \\\ \\\
Ta có thể biểu diễn sang: $(e \lor p) \leftrightarrow m$.
\clearpage
...
\textbf{Lời giải:} \\\ \\\
Ta có thể biểu diễn sang: $(\lnot m \land r \land b) \leftrightarrow g$.
\clearpage
